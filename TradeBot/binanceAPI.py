# source: https://github.com/yasinkuyu/binance-trader/blob/master/app/BinanceAPI.py
import time
import hashlib
import requests
import hmac
...
class BinanceAPI:
    ...
    def get_klines(self, market, interval, startTime=None, endTime=None, limit=None):
    ...
    def buy_limit(self, market, quantity, rate):
        path = f"{self.BASE_URL_V3}/order" + ("/test" if config.trade_test else "")
