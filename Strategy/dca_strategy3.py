...
class DCA_Strategy3(Strategy):
    def __init__(self, isRealTime=False):
        super().__init__()
        self.isRealTime = isRealTime

        # parameters
        self.trigPs = [0.60, 0.80, 0.8250, 0.828, 0.8692]
        self.invests = [i/400 for i in [100, 20, 40, 60, 80, 100]]
        self.trail_profit = 0.05
        self.trail_dca = 0.005
        self.profitP = 0.15
        self.stopLossP = 1
